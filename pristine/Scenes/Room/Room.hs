...
start = do
    ...
    -- Platforms
    makeWall (V3 (-10) (-roomH/2) 0) (V3 roomW wallD roomD) 0.1 [Teleportable]
    makeWall (V3 (10) (-roomH/2) 0) (V3 roomW wallD roomD) 0.1 [Teleportable]
    makeWall (V3 0 (-roomH/2) (-10)) (V3 roomW wallD roomD) 0.1 [Teleportable]
    makeWall (V3 0 (-roomH/2) (10)) (V3 roomW wallD roomD) 0.1 [Teleportable]

    makeWall (V3 0 (-roomH/2 + 10) (-20)) (V3 roomW wallD roomD) 0.5 [Teleportable]
